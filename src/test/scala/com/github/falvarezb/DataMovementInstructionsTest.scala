...
class DataMovementInstructionsTest extends AnyFunSpec with Matchers:
  describe("LDR parser") {
    it("successful parse when offset is an immediate value") {
      ...
      parseLdr(using instructionMetadata, Map.empty[String, InstructionLocation]) shouldBe Right(0x6041)
    }
    ...
    it("wrong destination register (DR)") {
      ...
      parseLdr(using instructionMetadata, Map.empty[String, InstructionLocation]) shouldBe Left("ERROR (file - line 1): Expected register but found R8")
    }
    ...
    it("offset too big") {
      ...
      parseLdr(using instructionMetadata, Map.empty[String, InstructionLocation]) shouldBe Left("ERROR (file - line 1): Immediate operand (40) out of range (-32 to 31)")
    }
    ...
    it("symbolic name not found") {
      ...
      parseLdr(using instructionMetadata, Map.empty[String, InstructionLocation]) shouldBe Left("ERROR (file - line 1): Symbol not found ('NON_EXISTENT_LABEL')")
    }
  }
  ...
  describe("STR parser") {
    it("successful parse when offset is an immediate value") {
      ...
      parseStr(using instructionMetadata, Map.empty[String, InstructionLocation]) shouldBe Right(0x7041)
    }
  }
  ...
  describe("LD parser") {
    it("successful parse when offset is an immediate value") {
      ...
      parseLd(using instructionMetadata, Map.empty[String, InstructionLocation]) shouldBe Right(0x2001)
    }
    ...
    it("wrong destination register (DR)") {
      ...
      parseLd(using instructionMetadata, Map.empty[String, InstructionLocation]) shouldBe Left("ERROR (file - line 1): Expected register but found R8")
    }
    ...
    it("offset too big") {
      ...
      parseLd(using instructionMetadata, Map.empty[String, InstructionLocation]) shouldBe Left("ERROR (file - line 1): Immediate operand (300) out of range (-256 to 255)")
    }
    ...
    it("symbolic name not found") {
      ...
      parseLd(using instructionMetadata, Map.empty[String, InstructionLocation]) shouldBe Left("ERROR (file - line 1): Symbol not found ('NON_EXISTENT_LABEL')")
    }
  }
  ...
  describe("ST parser") {
    it("successful parse when offset is an immediate value") {
      ...
      parseSt(using instructionMetadata, Map.empty[String, InstructionLocation]) shouldBe Right(0x3001)
    }
  }
  ...
  describe("LDI parser") {
    it("successful parse when offset is an immediate value") {
      ...
      parseLdi(using instructionMetadata, Map.empty[String, InstructionLocation]) shouldBe Right(0xa001)
    }
  }
  ...
  describe("STI parser") {
    it("successful parse when offset is an immediate value") {
      ...
      parseSti(using instructionMetadata, Map.empty[String, InstructionLocation]) shouldBe Right(0xb001)
    }
  }
  ...
  describe("LEA parser") {
    it("successful parse when offset is an immediate value") {
      val instructionMetadata = InstructionMetadata(LineMetadata("DOES NOT MATTER", List("STI", "R0", "1"), LineNumber(1), ""), InstructionLocation(0))
      parseLea(using instructionMetadata, Map.empty[String, InstructionLocation]) shouldBe Right(0xe001)
    }
  }
